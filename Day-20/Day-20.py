...
for i in range(N):
    ...
    #print(f"number: {numbers[current_index]}")
    #print(f"new index {new_index}")

    #debug_numbers = []
    #for n in range(N):
    #    debug_numbers.append(numbers[mix2orig[n]])
    #print(debug_numbers)
...
print(
    f"Result to task 1: {numbers[mix2orig[(zero_pos + 1000) % N]] + numbers[mix2orig[(zero_pos + 2000) % N]] + numbers[mix2orig[(zero_pos + 3000) % N]]}"
)
